...
import com.example.myapplication06.bean.UserInfo;
import com.example.myapplication06.database.UserDBHelper;
import com.example.myapplication06.util.DateUtil;
import com.example.myapplication06.util.ViewUtil;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"用户", "商家","秦川雨"};
    ...
    private void loginSuccess() {
        ...
        builder.setNegativeButton("打开商场",
